...
def display_attack_images(attack_data_linf, attack_data_l2, num_images=5):
    ...
    for idx, model_data in attack_data_linf.items():
        ...
        plot_images(labels.X.get_data()[:num_images], adv_images_linf[:num_images], adv_images_l2[:num_images],
                    labels.Y.get_data()[:num_images], model_idx=idx, num_images=num_images)
